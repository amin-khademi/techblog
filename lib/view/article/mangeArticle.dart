...
class ManageArticle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(appBar: appBar("مدریت مقاله"),
        ...
        bottomNavigationBar: Padding(
            ...
            child: Padding(
              ...
              child: ElevatedButton(
                style: ButtonStyle(fixedSize:MaterialStateProperty.all( Size(Get.width/3,40))),
                onPressed: () {
                },
                child: Text(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                                articleManagecontroller.articleList[index].image!,
  ...
  Column articleEmptyState(TextTheme themeData) {
    return Column(
        ...
        children: [
          Center(
              child: SvgPicture.asset(Assets.img.sing,height: 100,)),
          Padding(
